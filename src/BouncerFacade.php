 ...
 * @method static \Silber\Bouncer\Conductors\AssignsRoles assign(\Silber\Bouncer\Database\Role|\Illuminate\Support\Collection|string|\BackedEnum $roles)
 * @method static \Silber\Bouncer\Conductors\RemovesRoles retract(\Illuminate\Support\Collection|\Silber\Bouncer\Database\Role|string|\BackedEnum $roles)
 ...
 * @method static self define(string|\BackedEnum $ability, callable|string $callback)
 * @method static \Illuminate\Auth\Access\Response authorize(string|\BackedEnum $ability, array|mixed $arguments)
 ...
 * @method static bool cannot(string|\BackedEnum $ability, array|mixed $arguments)
 * @method static bool allows(string|\BackedEnum $ability, array|mixed $arguments)
 * @method static bool denies(string|\BackedEnum $ability, array|mixed $arguments)
